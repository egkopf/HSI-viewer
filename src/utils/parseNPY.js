...
export async function loadNpyVariable(file, datasetPath, options = {}) {
  try {
    ...
    console.log('🔍 NPY Data Type Analysis:');
    console.log('  NPY reported dtype:', dtype);
    console.log('  Actual JS data type:', data.constructor.name);
    console.log('  Data length:', data.length);
    
    // Sample a few values to check the data
